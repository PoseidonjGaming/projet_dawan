...
namespace SerieDLL_EF.Repository
{
    ...
    public class PersonnageRepository :BaseRepo, IRepoCRUD<Personnage>, IRepSpecials<Personnage>
    {
        public PersonnageRepository(string Cnx):base(Cnx)
        {
